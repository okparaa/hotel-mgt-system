...
const Aio = () => {
  ...
  return (
    <div className="h-fit flex flex-wrap gap-5 py-5 justify-evenly items-center link-btn-dash-container">
      <Lynk routes={routes} className="link-btn-dash" to="aio/dash/rooms">
        <Fragment>
          <Hotel className="font-bold w-7 h-7" /> <div>Rooms</div>
        </Fragment>
      </Lynk>
      <Lynk routes={routes} className="link-btn-dash" to="aio/orders/booking">
        <Fragment>
      ...
      <Lynk routes={routes} className="link-btn-dash" to="aio/orders/lost-card">
