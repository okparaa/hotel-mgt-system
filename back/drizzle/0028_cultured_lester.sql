...
ALTER TABLE "rooms" ALTER COLUMN "status" SET DATA TYPE boolean;--> statement-breakpoint
ALTER TABLE "rooms" ALTER COLUMN "status" SET DEFAULT false;--> statement-breakpoint
